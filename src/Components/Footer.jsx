                ...
                <div className="container py-5">
                    <div className="row g-5">
                        <div className="col-lg-4 col-md-6">
                            ...
                            <p className="mb-2">
                                <i className="fa fa-map-marker me-3"></i>Chandu, Sector 18, Noida
                            </p>
                            <Link className="mb-2 text-light d-block" to="tel:+917905622517">
                                <i className="fa fa-phone me-3"></i>+91-7905622517
                            </Link>
                            <Link className="mb-2 text-light d-block" to="mailto:chandramv990826@gmail.com">
                                <i className="fa fa-envelope me-3"></i>chandramv990826@gmail.com
                            </Link>
